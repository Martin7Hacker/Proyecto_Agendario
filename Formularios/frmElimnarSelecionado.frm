VERSION 5.00
Begin VB.Form frmElimnarSelecionado 
   ...
   ClientTop       =   3480
   ClientWidth     =   4560
   Icon            =   "frmElimnarSelecionado.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   549.475
   ...
   End
End
Attribute VB_Name = "frmElimnarSelecionado"
...
'* Programa frmEliminarSeleccionado de Agendario v1.0
...
Private Sub cmdOK_Click()
 If txtPassword = y_seguridad.y_eliminarSeleccionado Then
